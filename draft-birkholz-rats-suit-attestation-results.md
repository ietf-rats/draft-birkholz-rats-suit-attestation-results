...
All Claims associated with an identifiable SUIT Manifest SHOULD always be bundled together in a Claims set that is limited to the Claims defined in this document.
